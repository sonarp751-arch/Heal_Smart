        ...
        <div className="hs-container">
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <div>
                <strong style={{ fontSize: "0.95rem", display: "block", color: "white" }}>
                  Looking for Deep Multi-Omics Target Profiling & Signature Reversal?
                </strong>
                <span style={{ fontSize: "0.78rem", color: "#99F6E4" }}>
                  Explore GTEx tissue expression, GWAS disease genetics, and L1000/CMap transcriptomic perturbation scores.
                </span>
              </div>
            </div>
            <button
              className="hs-btn hs-btn-solid hs-btn-sm"
              onClick={() => navigate("/omics-discovery")}
              style={{ background: "#2DD4BF", color: "#042F2E", fontWeight: 700 }}
            >
              Open Omics Engine →
            </button>
          </div>
